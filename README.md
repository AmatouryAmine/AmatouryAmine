...
Backend engineer. Fintech production systems. Beirut.
...
I build backend systems for production — APIs, microservices, and data pipelines. My background is fintech and high-throughput transaction processing.
